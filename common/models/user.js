...
const speakeasy = require("speakeasy"),
  ...
  integration_facebook = require("../social/facebook"),
...
module.exports = function (user) {
  ...
  user.fb_login_call = function (data, fn) {
    integration_facebook.login_fb(user, data, fn);
  };
  user.ig_login_call = function (data, cb) {

  };
  user.ig_callback = function (code, cb) {
  ...
  user.remoteMethod("ig_login_call", {
    description: ["Update facebook login access channel in here.."],
    accepts: [
      {arg: "data", type: "object", http: {source: "body"}, required: true, description: "instagram login document"}
    ],
    returns: {
      arg: "token", type: "object", root: true, description: "Return value"
    },
    http: {verb: "post", path: "/login_ig"}
  });

  user.remoteMethod("ig_callback", {
    description: ["Update facebook login access channel in here.."],
    accepts: [
      {arg: "code", type: "string", http: {source: "form"}, required: true, description: "instagram login document"}
    ],
    returns: {
      arg: "token", type: "object", root: true, description: "Return value"
    },
    http: {verb: "post", path: "/callback_ig"}
  });
