...
const bankName = ["邮储银行·绿卡通", "邮储银行·绿卡银联标准卡", "邮储银行·绿卡银联标准卡", "邮储银行·绿卡专用卡", "邮储银行·绿卡银联标准卡",
...
module.exports.Base64 = function (idCard) {
  let index = -1;
